...
<KeyTakeaways>
  <p>Blog 切好 dark mode，code block 卻沒跟著變色該怎麼辦？把 CSS 從 media query 改成 class-based、用 inline script 防 FOUC，再用 Expressive Code 取代手刻的 code block；關鍵是 Expressive Code 不看 CSS class，而是靠 <code>data-theme</code> 屬性切換，所以 toggle 要同步設定。</p>
</KeyTakeaways>
