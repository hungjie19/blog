...
<KeyTakeaways>
  <p>需要另一位 AI 協作者時，為什麼不用 sub-agent？因為我要的是能隨時走進去接手、暫停後仍在的獨立現場，於是做了 summon-agent Skill：用 cmux CLI 開 workspace、啟動 runtime 並套上 Agent 角色，Agent 與帳號分開選；但這套輪詢式流程，對已經知道所有選項的情境仍嫌太多步。</p>
</KeyTakeaways>
