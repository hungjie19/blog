...
<KeyTakeaways>
  <p>架 blog 該選哪個框架？比較過 Hugo、Jekyll、Eleventy、Hexo 與 Next.js 之後我選 Astro：孤島架構讓頁面預設不輸出 JS，語法接近 Vue，style 又預設 scoped；這個結論的前提是「內容為主、互動為輔」的 blog 場景，而不是需要 SSR 或 API routes 的網站。</p>
</KeyTakeaways>
