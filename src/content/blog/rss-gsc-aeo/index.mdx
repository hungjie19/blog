...
<KeyTakeaways>
  <p>網站部署了，但沒人找得到，該做什麼？三條路各設定一次：用 @astrojs/rss 產生 feed 讓讀者訂閱、把 sitemap 提交到 Google Search Console 加速索引、再提供 raw markdown endpoint 讓 AI crawler 讀到乾淨內容；三件事各有各的協定，做完就不用再管。</p>
</KeyTakeaways>
