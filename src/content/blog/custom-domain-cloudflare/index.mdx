...
<KeyTakeaways>
  <p>GitHub Pages 的 github.io 網址該不該換成自己的 domain？值得換，SEO 與識別會累積在 domain 上，換平台資產也不歸零；文中記錄在 Cloudflare 買 domain、設 CNAME、綁定 GitHub Pages 與更新 Astro 設定的步驟，其中 SSL/TLS 必須選 Full，選 Flexible 會出現 redirect 迴圈。</p>
</KeyTakeaways>
